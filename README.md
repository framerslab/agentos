...
| Category | Highlights |
|---|---|
| **LLM Providers** | 12 (10 API-key + 2 local CLI): OpenAI, Anthropic, Gemini, Groq, Ollama, OpenRouter, Together, Mistral, xAI, Atlas Cloud, Claude CLI, Gemini CLI. Plus image/video/audio generation providers. |
